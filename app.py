...
def bohr_model(element):
    try:
        # Convert element to lowercase for case-insensitive lookup
        atomic_number = element_data.get(element.lower(), None)
...
def visualize_orbital(orbital_type):
    try:
        ...
        message = generate_orbital_visualization(orbital_type)  # Assume this returns a success message or path
